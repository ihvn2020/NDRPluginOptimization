...
public class ClinicalDictionary {
	...
	/*
	     Completed
	 */
	public List<HIVEncounterType> createHIVEncounterType(Patient patient, List<Encounter> allPatientEncounterList,
	        List<Obs> allPatientObsList) throws DatatypeConfigurationException {
		...
		Set<Date> visitDateSet = Utils.extractUniqueVisitsForEncounterTypes(patient, allPatientEncounterList,
		    encounterTypeArr);
	...
	public HIVEncounterType createHIVEncounterType(Patient patient, Date visitDate, List<Obs> obsListForOneVisit,
	        Date artStartDate) throws DatatypeConfigurationException {
		...
		if (obsSystolic != null && obsSystolic.getValueNumeric() != null && obsDystolic != null
		        && obsDystolic.getValueNumeric() != null) {
		...
		if (obs != null) {
			...
			oiDrugNameObs = Utils.extractObsByValues(Utils.OI_DRUGS_CONCEPT, Utils.COTRIMOXAZOLE_DRUG_CONCEPT,
			    obsGroupMembersList);
