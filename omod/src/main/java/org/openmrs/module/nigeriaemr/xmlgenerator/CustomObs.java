...
public class CustomObs implements Comparable<CustomObs> {
	...
	public void setObsGroupConceptId(int conceptId) {
		this.obsGroupConceptId = conceptId;
	}
	
	public int getObsGroupConceptId() {
		return this.obsGroupConceptId;
	}
